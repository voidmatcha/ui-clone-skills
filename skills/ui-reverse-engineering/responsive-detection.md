...
Desktop-first verification still needs responsive source analysis before generation.
Collect authored queries, fluid sizing, container ancestry, and layout/visibility
changes across layout bands. Initial reference probes establish implementation inputs;
they are not a full multi-viewport pixel verification sweep. Preserve discovered
variants even when their detailed verification is deferred until after desktop.
