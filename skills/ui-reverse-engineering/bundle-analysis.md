...
>
> **After this step:** Step 5c-b (`bundle-verification.md`), then Step 5c-c (`paid-features-detect.sh` → ⛔ Gate: `paid-features`), then Step 5c-d (`python -m ui_clone.clonability`), then Step 5d — produce `transition-spec.json` per `transition-spec-rules.md` (see `pipeline-execution.md`).
...
Then, after Steps 5c-b/5c-c/5c-d and the Step 5d `spec` gate, proceed to **Step 5e: Capture Verification** (in `transition-spec-rules.md`).
